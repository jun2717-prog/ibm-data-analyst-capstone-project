...
![Dashboard preview](current-technology-usage.jpg)
...
具体的には、データのクリーニング（整形）→ 探索的な分析 → グラフによる可視化 → 操作できるダッシュボードの作成、という流れで進めています。
...
![ダッシュボードのプレビュー](current-technology-usage.jpg)
